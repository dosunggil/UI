...
// 함수 본체에 다른 코드 없이 오로지 return 명령문만 있을 경우
...
const result1 = func61(500);
console.log(result1);

// std_buton.addEventListener("click", () => {});
// std_buton.addEventListener("click", function () {});
