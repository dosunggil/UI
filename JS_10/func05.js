/*
    ...
    클라이언트와 서버간에 데이터를 주고 받을 때 (Data Exchange) 
    ...
    네트워크를 통해서 데이터를 전송할 때 데이터 양을 획기적으로 줄일 수 있었다.
...
// 아래와 같은 코드가 실행될 때 만약 기존에 intMusic 속성이 있으면
// 값이 90으로 변경되고, 없으면 새로운 속성을 추가한다.
scoreVO.intMusic = 90;
